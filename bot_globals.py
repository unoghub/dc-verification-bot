import os
from discord import Guild,Object,PermissionOverwrite
...
TABLE_JAM_CURRENT : Table = DATABASE_UNOG.table("JAM_CURRENT")
TABLE_JAM_CURRENT_PARTICIPANTS : Table = DATABASE_UNOG.table("JAM_CURRENT_PARTICIPANTS")
TABLE_JAM_CURRENT_TEAMS : Table = DATABASE_UNOG.table("JAM_CURRENT_TEAMS")
TABLE_JAM_FORMS : Table = DATABASE_UNOG.table("JAM_FORMS")
...
TEXTCHANNELID_VERIFICATION_PANEL = int(os.getenv('TEXTCHANNELID_VERIFICATION_PANEL')) # Onay Paneli
TEXTCHANNELID_VERIFICATION = int(os.getenv('TEXTCHANNELID_VERIFICATION')) # Onay-Kayıt kanalı
TEXTCHANNELID_WELCOME = int(os.getenv('TEXTCHANNELID_WELCOME')) # Hoşgeldin kanalı

ROLEID_BOTDEV = int(os.getenv('ROLEID_BOTDEV'))
ROLEID_DIRECTOR = int(os.getenv('ROLEID_DIRECTOR')) # Direktör 
...
WELCOME_NEWCOMERS : bool = True
LOG_APPROVES : bool = True

PERMISSION_OVERWRITE_JAM_TEAM_MEMBER_VC : PermissionOverwrite = PermissionOverwrite(
                                                                            view_channel=True,
                                                                            read_messages=True,
...
PERMISSION_OVERWRITE_DEFAULT_ROLE : PermissionOverwrite = PermissionOverwrite(view_channel=False)
